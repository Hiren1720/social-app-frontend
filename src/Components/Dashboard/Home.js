                                                                                ...
                                                                                return (
                                                                                    <div className="m-auto text-gray-600 " key={index}>
                                                                                        <div
                                                                                            className="bg-white justify-between">
                                                                                            <div
                                                                                                className="flex items-center justify-between px-4 py-3  gap-2 lg:gap-1">
                                                                                                <div className='flex cursor-pointer'
                                                                                                    ...
                                                                                                    <div className="flex items-center justify-between">
                                                                                                        <h2
                                                                                                            className="text-lg items-center font-semibold text-gray-900 md:text-sm -mt-1">{ele?.author_info[0]?.name}</h2>
                                                                                                    </div>
                                                                                                </div>
